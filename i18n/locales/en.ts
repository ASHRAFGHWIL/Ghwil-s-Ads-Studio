export const en = {
  ...
  uploader: {
    ...
    logoSourceImage: "Reference Image (Logo Source)",
    uploadOrDrop: "Upload a file or drag and drop",
    fileTypes: "PNG, JPG, GIF up to 10MB",
  },
  controls: {
    logoSwap: "3. Logo Swap",
    logoSwapLabel: "Replace product logo with reference logo",
    lighting: "4. Lighting Type",
    cameraAngle: "5. Camera Angle",
    background: "6. Background Description (Optional)",
    backgroundPlaceholder: "e.g., on a marble countertop",
    styleIntensity: "7. Style Intensity: {intensity}%",
  ...
  errors: {
    ...
    "ERROR_MISSING_LOGO_IMAGE": "Please upload a logo source image when Logo Swap is enabled.",
